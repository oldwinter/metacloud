...
if (localOrRemote == 'y'){
  await $`kubectl create -f deploy/portal/portal-deployment.yaml`
  await $`kubectl create -f deploy/server/gin/gin-deployment.yaml`
  await $`kubectl create -f deploy/server/toy/toy-deployment.yaml`

  await $`kubectl create -f deploy/portal/portal-service.yaml`
  await $`kubectl create -f deploy/server/gin/gin-service.yaml`
  await $`kubectl create -f deploy/server/toy/toy-service.yaml`
